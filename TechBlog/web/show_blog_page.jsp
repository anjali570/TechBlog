...
<!--          <div id="fb-root"></div>
          <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v17.0" nonce="Pn86zObw"></script>-->
    ...
    <body>
       ...
       <li class="nav-item active">
           <a class="nav-link" href="profile.jsp"><span class="fa fa-bookmark"></span> Home <span class="sr-only">(current)</span></a>
       </li>
...
<!--                            <a href="#!" class="btn btn-outline-light btn-sm ml-2"><i class="fa fa-commenting-o"></i><span>20</span></a>-->
